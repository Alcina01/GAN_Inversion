...
def add_dgp_parser(parser):
    ...
    parser.add_argument(
        '--mask_file', type=str, default='',
        help='List file of the mask dataset (default: %(default)s)')
    parser.add_argument(
        '--gt_file', type=str, default='',
        help='List file of the gt dataset (default: %(default)s)')
    parser.add_argument(
        '--maskpair_file', type=str, default='',
        help='List file of the gt dataset (default: %(default)s)')
    parser.add_argument(
